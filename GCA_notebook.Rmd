...
run PCA with 4 factors, varimax rotation
...
Now compare to a factor analysis specifying 4 factors (based on scree plot), default rotation (oblimin), do not impute values for missing, use minimum residual factoring method (default) and view loading matrix
