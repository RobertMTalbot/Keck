...
Now filter (using dplyr) FSF_alldata for cl = 1 and Semester = Fa2015 from GCA_prepost, then calculate ES and g (based on averaging GCA pre and psot scores- not based on averaging individual <g> and ES) for this class (class 1 from Fall 2015). CHANGE <g> TO NORM CHANGE c
```{r}
library(dplyr)
